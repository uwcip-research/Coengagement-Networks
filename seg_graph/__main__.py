...
parser.add_argument('--mutual-limit', '-s', help='s parameter for mutual graphs if using input_data', type=int)
parser.add_argument('--connection-limit', '-n', help='n parameter for mutual graphs if using input_data', type=int)
